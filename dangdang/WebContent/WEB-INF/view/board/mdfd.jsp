...
<body class="is-preload">
	...
	<!-- Main -->
		...
		<div class="board">
			<form action="/board/mdfdimpl.do">
				<div id = "detailWrap">
					<div id = "detailBox">
						<div id = "title"><div id ="bdIdx">${board.bdIdx}</div><input type="text" name = "title" maxlength="10" autocomplete="off" required="required"  placeholder="${board.title}"></div>
						<input type="hidden" name = "bdIdx" value="${board.bdIdx}">
						<div id = "regDate">${board.regDate}</div>
						<div id = "content"><textarea name = "content" placeholder="${board.content}" required="required" style="width: 100%; height: 90%;"></textarea></div>
