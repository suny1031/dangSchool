						...
						<tr>
							...
							<c:if test="${count > 0}">
							   ...
							   <c:if test="${numPageGroup > 1}">
							        <a href="/board/userview.do?pageNum=${(numPageGroup-2)*pageGroupSize+1 }">[이전]</a>
							   </c:if>
							   
							   <c:forEach var="i" begin="${startPage}" end="${endPage}">
							       <a href="/board/userview.do?pageNum=${i}">
							        <font color=" #B22222" />
							   ...
							   <c:if test="${numPageGroup < pageGroupCount}">
							        <a href="/board/userview.do?pageNum=${numPageGroup*pageGroupSize+1}">[다음]</a>
							   </c:if>
							</c:if>
							</td>
						</tr>
